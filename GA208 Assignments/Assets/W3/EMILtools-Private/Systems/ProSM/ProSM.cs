...
namespace ProSM
{
    ...
    /// - AddUpdateLogic(), AddFixedUpdateLogic(), AddLateUpdateLogic() for state-specific tick logic
    /// - AddEnterLogic(), AddExitLogic() for state entry and exit logic
