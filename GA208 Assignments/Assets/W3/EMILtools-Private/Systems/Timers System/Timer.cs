...
namespace EMILtools.Timers
{
    ...
    public abstract class Timer
    {
        ...
        [ShowInInspector] [Range(0, 1)] public float Progress => initialTime != 0 ? Mathf.Clamp01(Time / initialTime) : 1;
        [FoldoutGroup("Timer")] [ShowInInspector] protected ClassRef<float> initialTime;
        ...
        protected Timer(ClassRef<float> _initialTime) 
        {
        ...
        public void SetInitialTime(ClassRef<float> _initialTime) => initialTime = _initialTime;
        ...
        public void TryTick(float deltaTime)
        {
            ...
            if (Time > initialTime)
            {
                Debug.Log("Rest to initial time: " + initialTime.val);
                Time = initialTime; // Clamp Time to initialTime
            }
